...
let random_num=parseInt((""+Math.random()).substring(2,7));
...
window.onload = function(){
    document.querySelector('#joinRoom').addEventListener('onclick',()=>{
        document.querySelector('#joinRoom').setAttribute('disabled','disabled');
    ...
    document.querySelector('#close_sample').addEventListener('onclick',()=>{
