# Video KYC: A Sample Web App using NodeJS and EnableX Web Toolkit
...
This basic  Video KYC Application is developed using HTML, CSS, Bootstrap, JavaScript, jQuery and EnxRtc (The EnableX Web Toolkit). Using Paid Subscription, the Application records Video Session.
